...
**[Download TempleEscape-v3.1.1.html](https://github.com/JosephDola/temple-escape/releases/download/v3.1.1/TempleEscape-v3.1.1.html)** · [Latest release](https://github.com/JosephDola/temple-escape/releases/latest)
...
- The repaired 21×21 layout now contains 322 active floor cells. Major connections are broad paired galleries instead of single-cell strips, while the Archive and Escape Wing deliberately narrow into gated choke points. The elevations remain continuously connected rather than simulated as stacked floors.
